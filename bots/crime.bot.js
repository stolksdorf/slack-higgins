...
Slack.onMessage((msg)=>{
	if(Slack.msgHas(msg.text, ['#20crimeteen', '#twentycrimeteen', '#20crimeteam', '#twentycrimeteam'])){
		Slack.sendAs('crimebot', 'police_car', msg.channel, `<https://gist.github.com/stolksdorf/${crimeGistID}|#20crimeteen!>`)
